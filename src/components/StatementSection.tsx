...
const steps = [
  {
    ...
    description:
      "Answer a few questions about your trip, your dates, and what you’re imagining. Takes about three minutes. No commitment.",
  },
  {
    number: "02",
    title: "Discovery call",
    description:
      "We talk through the trip — what you want, what you don’t, and what would make it a success for your specific group.",
  },
  {
    number: "03",
    title: "Proposal itinerary",
    description:
      "A curated proposal with two or three strong choices — all vetted, all right for your group. You pick what resonates.",
  },
  {
    number: "04",
      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-6xl">
        ...
        <div className="relative grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-0">
          ...
          {steps.map((step, index) => (
            ...
            >
              <div
                className="hidden lg:block absolute top-[2.15rem] left-0 h-3 w-3 rounded-full bg-primary ring-4 ring-background"
                aria-hidden="true"
              />
