      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-5xl">
        ...
        >
          ...
          <p className="text-background/75 text-base md:text-lg leading-relaxed font-sans max-w-2xl mx-auto mt-7 mb-10">
            Fill out the intake form or book a free discovery call. No pressure, no commitment — just a conversation
            about what you’re planning and whether I’m the right fit.
          </p>
